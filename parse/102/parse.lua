...
local chip = gamecommon.GetBetConfig(1,15)[1]
local tChip = chip * 15
...
function StatisticsIcons(data)
    for _, value in ipairs(data.winlines[1]) do
        iconmaps[value[5]] = iconmaps[value[5]] or {}
        iconmaps[value[5]][value[2]] = iconmaps[value[5]][value[2]] or 0
        iconmaps[value[5]][value[2]] = iconmaps[value[5]][value[2]] + 1
    end
end
